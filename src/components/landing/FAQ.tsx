  ...
  return (
    <section id="faq" className="py-20 sm:py-28 px-4 sm:px-6 lg:px-8 bg-background">
      <div className="max-w-3xl mx-auto">
        ...
        >
          <span className="inline-flex items-center gap-2 text-xs sm:text-sm font-semibold tracking-[0.2em] uppercase text-primary mb-4">
        ...
        >
          <Accordion type="single" collapsible className="space-y-3">
            {faqs.map((faq, index) => (
              ...
              >
                <AccordionTrigger className="text-left text-sm sm:text-base font-semibold hover:no-underline hover:text-primary transition-colors py-5">
                  {faq.question}
                </AccordionTrigger>
